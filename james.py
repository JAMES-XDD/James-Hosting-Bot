...
# CHANNELS
LOG_CHANNEL_ID = env_int("-1003850908144")
CHECK_CHANNELS = env_list("-1003850908144")
JOIN_URLS = env_list("https://t.me/Vegeta_Vouches")

# LINKS & MEDIA
TERMS_URL = os.getenv("https://james-xdd.github.io/Terms-And-Conditions/James.html")
...
def get_support_buttons():
    buttons = [
        [Button.url("📩 Contact ", f"https://t.me/{SUPPORT_USERNAME_1}")],
